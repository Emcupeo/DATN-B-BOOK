      ...
      <div class="mt-6 pt-4 border-t border-gray-100" v-if="description">
        <div class="flex items-center justify-between">
          ...
          <div class="flex items-center">
            <span class="text-sm font-semibold mr-2" v-if="trend === 'up'" :class="trendColor">
              <i class="fas fa-arrow-up mr-1"></i>
              {{ trendValue }}
            </span>
            <span class="text-sm font-semibold mr-2" v-else-if="trend === 'down'" :class="trendColor">
              <i class="fas fa-arrow-down mr-1"></i>
              {{ trendValue }}
            </span>
            <span class="text-sm font-semibold mr-2" v-else :class="trendColor">
