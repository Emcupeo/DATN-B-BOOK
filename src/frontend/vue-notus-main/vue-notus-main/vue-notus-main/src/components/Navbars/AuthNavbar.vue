        ...
        <ul class="flex flex-col lg:flex-row list-none lg:ml-auto">
          ...
          <li class="flex items-center">
            ...
            >
              ...
              ></i>
              <span class="lg:hidden inline-block ml-2">Chia sẻ</span>
            </a>
          </li>
          <li class="flex items-center">
            <a
          ...
          <li class="flex items-center">
            ...
            >
              ...
              ></i>
              <span class="lg:hidden inline-block ml-2">Thả sao</span>
            </a>
          </li>
          <li class="flex items-center">
            <button
              ...
              type="button"
            >
              <i class="fas fa-arrow-alt-circle-down"></i> Tải xuống
            </button>
          </li>
        </ul>
      </div>
